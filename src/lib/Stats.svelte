...
export let stats = [
	{ name: 'Roofs', value: '8956', type: 'decimal', duration: 1000 },
	{ name: 'Years in Business', value: '20', type: 'decimal', duration: 1000 },
	{ name: 'Locations', value: '22', type: 'decimal', duration: 1000 },
	{ name: 'Reviews', value: '107', type: 'decimal', duration: 3000 }
]
...
<Content class="w-full flex items-center justify-center lg:mx-0 lg:w-auto lg:gap-20">
	...
	{#each stats as stat}
      ...
      "
			...
			<p class="text-xs mt-1 text-center text-gray-400 font-medium lg:text-lg lg:-mt-2 uppercase">
				{stat.name}
			</p>
		</div>
	{/each}
